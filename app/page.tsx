    ...
    <>
      ...
      >
        ...
        className={`fixed top-0 left-0 right-0 z-50 ${
          isDarkMode ? "bg-black/90" : "bg-[#FAFAFA]/90"
        } backdrop-blur-xl border-b ${
          isDarkMode ? "border-[#D62828]/30" : "border-[#2B2D42]/30"
        }`}
        initial={{ y: -100 }}
        animate={{ y: 0 }}
          ...
          <div className="flex justify-between items-center">
            ...
            <motion.div
              className={`text-2xl font-bold bg-gradient-to-r ${
                isDarkMode
                  ? "from-[#D62828] to-[#FF4D6D]"
                  : "from-[#D62828] to-[#E76F51]"
            ...
            {/* Abas principais (visíveis em md ou maior) */}
              ...
              {tabs.map((tab) => (
                <button
                  ...
                  onClick={() => {
                    ...
                    // Opcional: fechar o menu mobile caso estivesse aberto
                    setMenuOpen(false);
                  }}
            ...
            {/* Botões de Toggle de Tema, Download e Menu (em telas pequenas) */}
             <motion.nav
        className={`fixed top-0 left-0 right-0 z-50 ${
          isDarkMode ? "bg-black/90" : "bg-[#FAFAFA]/90"
        } backdrop-blur-xl border-b ${
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              {/* ––– Toggle de tema (idêntico ao seu) ––– */}
              <label className="inline-flex items-center relative">
                ...
                <div
                  className={`relative w-[88px] h-[40px] cursor-pointer bg-[#FAFAFA] peer-checked:bg-black rounded-full
                    ...
                    shadow-sm duration-300 after:duration-300 border ${
                      isDarkMode ? "border-[#5a5a5a]" : "border-[#2B2D42]/20"
                    }`}
                ></div>
                {/* Ícone de Sol */}
                <svg
                ...
                <svg
                  ...
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
                  className={`fill-[#2B2D42] opacity-60 peer-checked:opacity-100 ${
                    isDarkMode ? "peer-checked:fill-[#e24444]" : "peer-checked:fill-[#D62828]"
                  } absolute w-5 h-5 right-[10px] transition-all duration-300`}
                >
              ...
              <Button
                ...
                size="sm"
                className={`${
                  isDarkMode ? "border-[#D62828] text-[#D62828]" : "border-[#2B2D42] text-[#2B2D42]"
          ...
          {/* ▼▼▼ Dropdown de abas (visível apenas quando menuOpen === true em telas pequenas) ▼▼▼ */}
          <AnimatePresence>
            {menuOpen && (
              <motion.div
